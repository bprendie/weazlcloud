...
Known limitations / decisions needed: The generated archive lifetime is currently two hours and must be confirmed before P5.2c is marked complete. The live smoke used temporary data under `/tmp`; the archive implementation stages under each user's configured data directory.
Next task: Confirm generated-ZIP retention, then P5.3 deletion and retention.
